...
export default function ThemeToogleHome() {
  ...
  //       <div tabIndex={0} role="button" className="btn btn-sm btn-ghost m-0 p-1">
  //         <SunTheme />
  //         <svg width="8px" height="8px" className="h-2 w-2 fill-current opacity-60 inline-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048"><path d="M1799 349l242 241-1017 1017L7 590l242-241 775 775 775-775z"></path></svg>
  //       </div>
  //       <ul tabIndex={0} className="dropdown-content z-[1] p-1 shadow-2xl bg-base-300 rounded-box w-40">
