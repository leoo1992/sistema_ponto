...
export const NotifySuccess = ({
  ...
  return (
    <div
      ...
      backdrop-blur-sm transition-transform duration-500 ease-in-out ${opacityEntry}`}
      style={{
...
export const notifySuccess = ({ text, duration=3000 }: { text?: string; duration?: number; }) => {
  toast.custom(
    () => <NotifySuccess text={text} duration={duration} />,
    {
      duration: duration,
      position: "top-right",
    },
